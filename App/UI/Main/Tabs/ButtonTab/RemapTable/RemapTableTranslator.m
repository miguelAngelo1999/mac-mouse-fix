...
//        }},
        ...
        @{@"ui": NSLocalizedString(@"drag-effect.notification-center", @"Notification Center"), @"tool": NSLocalizedString(@"drag-effect.notification-center.hint", @"Swipe left to open Notification Center, right to close\n \nWorks like a two-finger swipe from the right edge of a trackpad"), @"dict": @{
